...
SWT_LIB     = $(SWT_PREFIX)-$(WS_PREFIX)-$(SWT_VERSION).lib
...
GDIP_LIB     = $(GDIP_PREFIX)-$(WS_PREFIX)-$(SWT_VERSION).lib
GDIP_LIBS    = gdi32.lib gdiplus.lib msvcrt.lib kernel32.lib libcmt.lib
...
CFLAGS = -c -W3 /GS- -Gs8192 -O1 $(SWT_CDEBUG) -DSWT_VERSION=$(SWT_VERSION) $(NATIVE_STATS) $(SWT_WINDOWS_SDK) -DVC_EXTRALEAN -nologo -MT -D_X86_=1 -DWIN32 -D_WIN32 -D_WIN32_DCOM /I"$(JAVA_HOME)\include" /I"$(JAVA_HOME)\include\win32" /I.
