...
final class GoToDialog extends Dialog {
	...
	SelectionAdapter hexTextSelectionAdapter = new SelectionAdapter() {
		 ...
		 * (lastHexButtonSelected) return; String textNew =
		 * text.getText(); textNew =
	 ...
	 * (!lastHexButtonSelected) return; String textNew = text.getText();
	 * textNew = Integer.toString(Integer.parseInt(textNew, 16));
	 * text.setText(textNew); // generate event lastHexButtonSelected =
	 * false; } };
	 */
