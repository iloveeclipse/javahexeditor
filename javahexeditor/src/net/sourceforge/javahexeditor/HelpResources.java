...
public final class HelpResources {
     ...
     *            relevant resources will be copied to the file system in this
     *            case.
     ...
     *            <code>null</code>.
     * @param filePath
     *            The file path or <code>null</code> if the resource path shall
     *            be used.
     * @return
     */
    private static File writeResource(String resourcePath, String filePath) {
        if (resourcePath == null) {
            throw new IllegalArgumentException(
                    "Parameter 'resourcePath' must not be null.");
        }
        if (filePath == null) {
            filePath = resourcePath;
        }
        InputStream inStream = HelpResources.class
                .getResourceAsStream(resourcePath);
        if (inStream == null) {
            throw new RuntimeException("Help file '" + resourcePath
