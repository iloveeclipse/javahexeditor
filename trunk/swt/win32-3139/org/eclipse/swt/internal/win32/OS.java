...
public class OS extends Platform {
	...
	* SWT Windows flags
	*/
	public static boolean IsWin32s=false;
	public static boolean IsWin95=false;
	public static boolean IsWinNT=false;
	...
	public static boolean IsDBLocale=false;
	public static boolean IsUnicode=false;
	public static int WIN32_MAJOR=0, WIN32_MINOR=0, WIN32_VERSION=0;
	public static int COMCTL32_MAJOR=0, COMCTL32_MINOR=0, COMCTL32_VERSION=0;
	public static int SHELL32_MAJOR=0, SHELL32_MINOR=0, SHELL32_VERSION=0;
...
try{OS.GetVersionExW((OSVERSIONINFOW)info);}catch(UnsatisfiedLinkError e){return;}
...
//	static {
		dvi = new DLLVERSIONINFO ();
		dvi.cbSize = DLLVERSIONINFO.sizeof;
		dvi.dwMajorVersion = 4;
		lpLibFileName = new TCHAR (0, "Shell32.dll", true); //$NON-NLS-1$
...
COLOR_GRAYTEXT = 0x11 | SYS_COLOR_INDEX_FLAG;
...
HDM_GETITEM = IsUnicode ? HDM_GETITEMW : HDM_GETITEMA;
HDM_INSERTITEM = IsUnicode ? HDM_INSERTITEMW : HDM_INSERTITEMA;
HDM_SETITEM = IsUnicode ? HDM_SETITEMW : HDM_SETITEMA;
...
TTM_GETTOOLINFO = 0x400 + (IsUnicode ? 53 : 8);
...
WS_OVERLAPPED = IsWinCE ? WS_BORDER | WS_CAPTION : 0x0;
	...
	/* Flag used on WinCE */
	static int SYS_COLOR_INDEX_FLAG = OS.IsWinCE ? 0x40000000 : 0x0;
	...
	*/
	...
	public static int BFFM_SETSELECTION = IsUnicode ? 0x467 : 0x466;
	public static int BFFM_VALIDATEFAILED = IsUnicode ? 0x4 : 0x3;
	...
	public static int COLOR_3DDKSHADOW = 0x15 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_3DFACE = 0xf | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_3DHIGHLIGHT = 0x14 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_3DHILIGHT = 0x14 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_3DLIGHT = 0x16 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_3DSHADOW = 0x10 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_ACTIVECAPTION = 0x2 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_BTNFACE = 0xf | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_BTNHIGHLIGHT = 0x14 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_BTNSHADOW = 0x10 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_BTNTEXT = 0x12 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_CAPTIONTEXT = 0x9 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_GRADIENTACTIVECAPTION = 0x1b | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_GRADIENTINACTIVECAPTION = 0x1c | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_GRAYTEXT = 0x11 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_HIGHLIGHT = 0xd | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_HIGHLIGHTTEXT = 0xe | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_INACTIVECAPTION = 0x3 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_INACTIVECAPTIONTEXT = 0x13 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_INFOBK = 0x18 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_INFOTEXT = 0x17 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_MENU = 0x4 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_MENUTEXT = 0x7 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_SCROLLBAR = 0x0 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_WINDOW = 0x5 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_WINDOWFRAME = 0x6 | SYS_COLOR_INDEX_FLAG;
	public static int COLOR_WINDOWTEXT = 0x8 | SYS_COLOR_INDEX_FLAG;
...
//	public static final int EVENT_OBJECT_SELECTION = 0x8006;
	...
	public static int HDM_GETITEM = IsUnicode ? HDM_GETITEMW : HDM_GETITEMA;
	...
	public static int HDM_INSERTITEM = IsUnicode ? HDM_INSERTITEMW : HDM_INSERTITEMA;
	...
	public static int HDM_SETITEM = IsUnicode ? HDM_SETITEMW : HDM_SETITEMA;
	public static final int HDN_FIRST = 0xfffffed4;
	public static final int HDN_BEGINDRAG = HDN_FIRST - 10;
	public static int HDN_BEGINTRACK = IsUnicode ? 0xfffffeba : 0xfffffece;
	...
	public static int HDN_DIVIDERDBLCLICK = IsUnicode ? HDN_DIVIDERDBLCLICKW : HDN_DIVIDERDBLCLICKA;
	public static final int HDN_ENDDRAG = HDN_FIRST - 11;
	public static int HDN_ITEMCHANGED = IsUnicode ? 0xfffffebf : 0xfffffed3;
	...
	public static int HDN_ITEMDBLCLICK = IsUnicode ? HDN_ITEMDBLCLICKW : HDN_ITEMDBLCLICKA;
	...
	public static int LVM_GETCOLUMN = IsUnicode ? 0x105f : 0x1019;
	...
	public static int LVM_GETITEM = IsUnicode ? 0x104b : 0x1005;
	...
	public static int LVM_GETSTRINGWIDTH = IsUnicode ? 0x1057 : 0x1011;
	...
	public static int LVM_INSERTCOLUMN = IsUnicode ? 0x1061 : 0x101b;
	public static int LVM_INSERTITEM = IsUnicode ? 0x104d : 0x1007;
	...
	public static int LVM_SETCOLUMN = IsUnicode ? 0x1060 : 0x101a;
	...
	public static int LVM_SETITEM = IsUnicode ? 0x104c : 0x1006;
	...
	public static int NOTIFYICONDATA_V2_SIZE = IsUnicode ? NOTIFYICONDATAW_V2_SIZE : NOTIFYICONDATAA_V2_SIZE;
	...
	public static int RB_GETBANDINFO = IsUnicode ? 0x41c : 0x41d;
	...
	public static int RB_INSERTBAND = IsUnicode ? 0x40a : 0x401;
	public static final int RB_MOVEBAND = 0x427;
	public static int RB_SETBANDINFO = IsUnicode ? 0x40b : 0x406;
	...
	public static int SW_RESTORE = IsWinCE ? 0xd : 0x9;
	public static final int SW_SCROLLCHILDREN = 0x1;
	public static final int SW_SHOW = 0x5;
	public static int SW_SHOWMAXIMIZED = IsWinCE ? 0xb : 0x3;
	...
	public static int TB_ADDSTRING = IsUnicode ? 0x44d : 0x41c;
	...
	public static int TB_GETBUTTONINFO = IsUnicode ? 0x43f : 0x441;
	public static final int TB_GETBUTTONSIZE = 0x43a;
	public static int TB_GETBUTTONTEXT = IsUnicode ? 0x44b : 0x42d;
	...
	public static int TB_INSERTBUTTON = IsUnicode ? 0x443 : 0x415;
	public static final int TB_LOADIMAGES = 0x432;
	public static int TB_MAPACCELERATOR = 0x0400 + (IsUnicode ? 90 : 78);
	public static final int TB_SETBITMAPSIZE = 0x420;
	public static int TB_SETBUTTONINFO = IsUnicode ? 0x440 : 0x442;
	...
	public static int TCM_INSERTITEM = IsUnicode ? 0x133e : 0x1307;
	public static final int TCM_SETCURSEL = 0x130c;
	public static final int TCM_SETIMAGELIST = 0x1303;
	public static int TCM_SETITEM = IsUnicode ? 0x133d : 0x1306;
	...
	public static int TTM_ADDTOOL = IsUnicode ? 0x432 : 0x404;
	public static int TTM_DELTOOL = IsUnicode ? 0x433 : 0x405;
	public static int TTM_GETTOOLINFO = 0x400 + (IsUnicode ? 53 : 8);
	...
	public static int TTN_GETDISPINFO = IsUnicode ? 0xfffffdee : 0xfffffdf8;
	...
	public static int TVM_GETITEM = IsUnicode ? 0x113e : 0x110c;
	...
	public static int TVM_INSERTITEM = IsUnicode ? 0x1132 : 0x1100;
	...
	public static int TVM_SETITEM = IsUnicode ? 0x113f : 0x110d;
...
//	public static final int WM_GETICON = 0x7f;
	...
	public static int WS_MAXIMIZEBOX = IsWinCE ? 0x20000 : 0x10000;
	public static int WS_MINIMIZEBOX = IsWinCE ? 0x10000 : 0x20000;
	public static int WS_OVERLAPPED = IsWinCE ? WS_BORDER | WS_CAPTION : 0x0;
