...
public class Callback {
	...
	static int PTR_SIZEOF = 4;//PTR_sizeof();
	static String PTR_SIGNATURE = PTR_SIZEOF == 4 ? "I" : "J"; //$NON-NLS-1$  //$NON-NLS-2$
	static String SIGNATURE_0 = getSignature(0);
	static String SIGNATURE_1 = getSignature(1);
	static String SIGNATURE_2 = getSignature(2);
	static String SIGNATURE_3 = getSignature(3);
	static String SIGNATURE_4 = getSignature(4);
	static String SIGNATURE_N = "(["+PTR_SIGNATURE+")"+PTR_SIGNATURE; //$NON-NLS-1$  //$NON-NLS-2$
static{initStatic();}
public static void initStatic(){
try{PTR_sizeof();}catch(UnsatisfiedLinkError e){return;}
PTR_SIZEOF = PTR_sizeof();
PTR_SIGNATURE = PTR_SIZEOF == 4 ? "I" : "J"; //$NON-NLS-1$  //$NON-NLS-2$
