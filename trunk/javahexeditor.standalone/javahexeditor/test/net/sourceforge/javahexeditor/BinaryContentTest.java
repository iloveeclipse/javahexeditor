...
public class BinaryContentTest extends TestCase {
	...
	public final void testCopyManyFileMaps() {
		try {
	...
	public final void testInsertByte() {
		try {
	...
	public final void testInsertAtBeginningOfFile() {
		try {
	...
	public final void testInsertThenDelete() {
		try {
	 ...
	 */
	public final void testOverwriteByte() {
		try {
	...
	public final void testOverwriteThenInsert() {
		try {
	...
	public final void testRangesModified() {
		try {
			ArrayList rangesModified = new ArrayList();
			
			content.overwrite((byte)13, 128);
			assertEquals(8, content.get(data, rangesModified, 125));
			assertEquals(2, rangesModified.size());
			assertEquals(128, ((Long)rangesModified.get(0)).intValue());
			assertEquals(1, ((Long)rangesModified.get(1)).intValue());
			
			content.insert((byte)14, 127);
			data.position(0);
			assertEquals(8, content.get(data, rangesModified, 125));
			assertEquals(4, rangesModified.size());
			assertEquals(127, ((Long)rangesModified.get(0)).intValue());
			assertEquals(1, ((Long)rangesModified.get(1)).intValue());
			assertEquals(129, ((Long)rangesModified.get(2)).intValue());
			assertEquals(1, ((Long)rangesModified.get(3)).intValue());

			content.overwrite((byte)15, 126);
			data.position(0);
			assertEquals(8, content.get(data, rangesModified, 125));
			assertEquals(6, rangesModified.size());
			assertEquals(126, ((Long)rangesModified.get(0)).intValue());
			assertEquals(1, ((Long)rangesModified.get(1)).intValue());
			assertEquals(127, ((Long)rangesModified.get(2)).intValue());
			assertEquals(1, ((Long)rangesModified.get(3)).intValue());
			assertEquals(129, ((Long)rangesModified.get(4)).intValue());
			assertEquals(1, ((Long)rangesModified.get(5)).intValue());
			...
			assertEquals(2, rangesModified.size());
			assertEquals(0, ((Long)rangesModified.get(0)).intValue());
			assertEquals(1, ((Long)rangesModified.get(1)).intValue());
		} catch (IOException e) {
			throw new RuntimeException(e);
		}
	...
	public final void testRangesModifiedAtEndOfFile() {
		try {
			ArrayList rangesModified = new ArrayList();
			...
			assertEquals(2, rangesModified.size());
			assertEquals(256, ((Long)rangesModified.get(0)).intValue());
			assertEquals(1, ((Long)rangesModified.get(1)).intValue());
		} catch (IOException e) {
			throw new RuntimeException(e);
		}
	...
	public final void testRangesModifiedUnconnexInserts() {
		try {
			ArrayList rangesModified = new ArrayList();
			...
			assertEquals(0, ((Long)rangesModified.get(0)).intValue());
			assertEquals(1, ((Long)rangesModified.get(1)).intValue());
			assertEquals(2, ((Long)rangesModified.get(2)).intValue());
			assertEquals(1, ((Long)rangesModified.get(3)).intValue());
		} catch (IOException e) {
			throw new RuntimeException(e);
		}
